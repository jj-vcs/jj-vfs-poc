// NOTE: This file is shared between unit tests and integration tests.
// It is symlinked at `src/vfs/test_helpers.rs` pointing to
// `tests/test_helpers.rs`. This is only for the PoC and should be changed in
