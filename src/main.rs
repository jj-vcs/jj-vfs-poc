...
use crate::mappers::all_commits_mapper::AllCommitsMapper;
...
fn main() {
    ...
    let mapper = AllCommitsMapper::new(readonly_repo);

    println!("Mounting JjVfs at {}...", mountpoint);
    let _session = fuser::spawn_mount(fuse::JjVfs::new(mapper), mountpoint, &config)
